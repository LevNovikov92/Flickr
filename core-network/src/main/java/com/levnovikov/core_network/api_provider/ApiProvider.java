...
public class ApiProvider {
    ...
    @VisibleForTesting
    <T> Request getRequest(Request.Method method, String path, T request, @Nullable Map<String, String> pathParams) {
    ...
    @VisibleForTesting
    <R> R getResponse(Response rsp, Class<R> responseClass) throws IOException {
    ...
    public static class Builder {
        ...
        Builder converter(EntityConverter converter) {
