...
public class HttpClientImpl implements HttpClient {
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            client.threadComposer = new NetworkThreadComposer();
        }
        ...
        public Builder addTransformer(RequestTransformer transformer) {
            client.requestTransformers.add(transformer);
            return this;
        }

        public Builder addTransformer(ResponseTransformer transformer) {
